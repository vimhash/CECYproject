...
class CreateInformacionEstudiantesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('informacion_estudiantes', function (Blueprint $table) {
            ...
            $table->string('idioma_ancestral')->nullable()->default('');
            ...
            $table->string('tipo_discapacidad', 100)->nullable()->default('7');
            $table->string('tipo_financiamiento_beca', 50)->nullable()->default('4');
