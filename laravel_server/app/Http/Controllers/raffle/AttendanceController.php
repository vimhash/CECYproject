...
class AttendanceController extends Controller
{
    ...
    public function summary(Request $request)
    {
       ...
       authentication.users.second_name,
        min(case when catalogues.code = 'work' then cecy.workdays.start_time end) as start_time,
        max(case when catalogues.code = 'work' then cecy.workdays.end_time end) as end_time,
       ...
       sum(case when catalogues.code = 'lunch' then workdays.duration end) as lunch
        from cecy.attendances
         ...
         inner join cecy.catalogues on workdays.type_id = catalogues.id
